...
@property (strong, nonatomic) NSArray *titlelabes;
@end
...
-(void) setupWithLocalArray:(NSArray *)array{
    ...
    UILabel *titleLab = [[UILabel alloc] initWithFrame:CGRectMake(10, 20, self.frame.size.width - 20, 14)];
...
-(void) setup{
    ...
    self.wheelPageControl.currentPageIndicatorTintColor = [UIColor grayColor];
...
- (void) updateWheel{
    ...
    [self.titleDelegate titleIndexPage:self.currentImageIndex];
}
